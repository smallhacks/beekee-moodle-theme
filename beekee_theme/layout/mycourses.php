...
// BEEKEE @ 10/11/2022 Vincent Widmer
// Get courses where current user is enrolled in
// Necessary to show only categories which contain courses where user is enrolled in (see below)
...
echo $OUTPUT->render_from_template('theme_beekee_theme/mycourses', $templatecontext);
