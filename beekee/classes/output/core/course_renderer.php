...
namespace theme_beekee\output\core;
...
/**
 * Renderers to align Beekee's course elements to what is expect
 *
 * @package    theme_beekee
 * @copyright  2019 Vincent Widmer, based on Boost and Moov themes
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
/**
    ...
    public function course_info_box(stdClass $course) {
        ...
        $chelper->set_show_courses(self::COURSECAT_SHOW_COURSES_EXPANDED);
        $content .= $this->coursecat_coursebox_info($chelper, $course);
     ...
     * @return string
     */
    protected function coursecat_coursebox_info(coursecat_helper $chelper, $course, $additionalclasses = '') {
        ...
        $content .= $this->coursecat_coursebox_content_info($chelper, $course);
     ...
     * @return string
     */
    protected function coursecat_coursebox_content_info(coursecat_helper $chelper, $course) {
        global $CFG;
        if ($chelper->get_show_courses() < self::COURSECAT_SHOW_COURSES_EXPANDED) {
            return '';
        }
 ...
 /**
    ...
    protected function coursecat_coursebox(coursecat_helper $chelper, $course, $additionalclasses = '') {
        ...
        $content = '';
        $classes = trim('coursebox courseboxitem learfix '. $additionalclasses);
        if ($chelper->get_show_courses() >= self::COURSECAT_SHOW_COURSES_EXPANDED) {
            $nametag = 'h3';
        } else {
            $classes .= ' collapsed';
